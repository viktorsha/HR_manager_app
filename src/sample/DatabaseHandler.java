...
public class DatabaseHandler extends Configs {
    ...
    public ResultSet getUser(User manager)
    {
        ...
        String select = "SELECT * FROM " + Const.EMPLOYEE_TABLE+" WHERE "+ Const.USERS_NAME + "=? AND "+    Const.USERS_PASS + "=?";
        try
        {
    ...
    public void setDefault() throws SQLException, ClassNotFoundException, FileNotFoundException {
        ...
        Reader reader = new BufferedReader(new FileReader("H:\\Viktoria\\University\\3 course\\Курсовая\\App1\\src\\sample\\generateDB.sql"));
        sr.runScript(reader);
    }
